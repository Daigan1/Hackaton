...
<p>${props.description}</p><code><textarea id ="code" style = "margin-top: 5px; padding-left: 7px; padding-top: 7px; padding-right: 7px;" rows="20" cols="42" placeholder = "Code" type="text"></textarea></code>
